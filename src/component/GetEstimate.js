                    ...
                    <div class="modal-content">
                        ...
                        <div class="modal-body custom-modal-body p-sm-4 p-lg-0 p-md-0 pe-md-4 pe-lg-4 p-4">
                            <div className="row text-center align-items-center">
                                <button type="button" class="btn-close estimate-close" data-bs-target="#estimateModal" data-bs-dismiss="modal" aria-label="Close"></button>
                                <div className="col-lg-5 col-md-6 col-sm-12 col-12 d-lg-block d-md-block d-none">
                                    <div className="left-side">
                                        <h2 className='get-estimate'> Get an <br /> Estimate</h2>
                                ...
                                <div className="col-lg-7 col-md-6 col-sm-12 col-12">
                                    <div className="right-side">
                                        <div className="vehicle-card">
                                            <div className="card-popup d-flex align-items-center justify-content-between" data-bs-target="#exampleModalToggle2" data-bs-toggle="modal">
                                                <img src={bike} alt="" />
                                                <p className='m-0'>Two Wheelers</p>
                                                <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 40 40" fill="none">
                                                    <g clip-path="url(#clip0_175_128)">
                                                        <path d="M9.7998 6.86659L22.9331 19.9999L9.7998 33.1333L13.3331 36.6666L29.9998 19.9999L13.3331 3.33325L9.7998 6.86659Z" fill="#6D6D6D" fill-opacity="0.5" />
                                                    </g>
                                                    <defs>
